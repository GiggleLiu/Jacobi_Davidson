...
htmlhelp_basename = 'pydavidson-doc'
...
latex_documents = [
  (master_doc, 'PyDavidson.tex', u'PyDavidson Documentation',
   u'JinGuo Leo', 'manual'),
]
...
man_pages = [
    (master_doc, 'pydavidson', u'PyDavidson Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'PyDavidson', u'PyDavidson Documentation',
   author, 'PyDavidson', 'Python Implementation of Jacobi-Davidson Method for complex symmetric matrix.',
   'Miscellaneous'),
]
