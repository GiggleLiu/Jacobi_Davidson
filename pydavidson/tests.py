...
class Test(object):
    ...
    def test_jd_min(self):
        ...
        # perturb=random.random((N,1))*1e-2
        # v=_normalize(v+perturb)
        e2, v2 = JDh(mat, k=k, v0=None, tol=1e-12, maxiter=1000, which='SA', sigma=5,
    ...
    def test_jd_sigma(self):
        ...
        e2, v2 = JDh(mat, k=k, v0=None, K=K, tol=1e-12, maxiter=1000, which='SL', sigma=0,
                     linear_solver_maxiter=20, linear_solver='bicgstab', linear_solver_precon=True, iprint=1)
        t1 = time.time()
    ...
    def test_jd_general(self):
        ...
        t1 = time.time()
        e2, v2 = JDh(mat, k=k, v0=None, M=M, tol=1e-5, maxiter=1000, which='SA', sigma=-500,
                     linear_solver_maxiter=20, linear_solver='lgmres', linear_solver_precon=True, iprint=0)
        t2 = time.time()
